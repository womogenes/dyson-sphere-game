 ...
 * https://github.com/ektogamat/fake-glow-material-threejs/blob/main/src/FakeGlowMaterial.js
 */
import {
  ShaderMaterial,
  Uniform,
...
class FakeGlowMaterial extends ShaderMaterial {
   ...
   * @param {Color} [parameters.glowColor=new Color('#ffffff')] - The color of the glow effect.
   ...
   * @param {boolean} [parameters.depthTest=true] - Enable or disable depth testing.
   */
  ...
  constructor(parameters = {}) {
    ...
    this.depthTest =
      parameters.depthTest !== undefined ? parameters.depthTest : true;
    this.blending =
